...
/**
 * SLAMModule - Real-time Visual SLAM for Mobile Web
...
export default function SLAMModule() {
  ...
  return (
    <div className="w-full h-full bg-linear-to-br from-zinc-950 via-zinc-900 to-zinc-950 text-white overflow-y-auto flex flex-col">
      {/* Hero / Header */}
      <div className="p-6 md:p-8 border-b border-white/10 bg-white/5 backdrop-blur-md shadow-lg">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-zinc-300 mt-2 max-w-2xl">
              Camera-first view with live obstacle overlays, LiDAR/depth status,
          ...
          <div className="flex flex-col gap-2 items-start md:items-end">
            <div className="flex gap-2 flex-wrap justify-end">
              <button
                onClick={handleStart}
                disabled={isRunning}
                className="px-4 py-2 rounded-lg bg-linear-to-r from-violet-500 to-indigo-500 text-zinc-950 font-semibold shadow-lg shadow-violet-500/30 hover:brightness-110 disabled:opacity-50 text-sm"
              >
                Start
              </button>
              <button
                onClick={handleStop}
                disabled={!isRunning}
                className="px-4 py-2 rounded-lg bg-linear-to-r from-fuchsia-500 to-red-500 text-zinc-950 font-semibold shadow-lg shadow-fuchsia-500/30 hover:brightness-110 disabled:opacity-50 text-sm"
              >
                Stop
              </button>
              <button
                onClick={handleReset}
                className="px-4 py-2 rounded-lg bg-zinc-800 border border-white/10 font-semibold text-sm hover:border-white/30"
              >
                Reset
              </button>
              <button
                ...
                className={`px-4 py-2 rounded-lg font-semibold text-sm border transition ${
                  torchEnabled
                    ? "bg-fuchsia-500/90 text-zinc-950 border-fuchsia-300"
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 px-6 md:px-8 py-4 bg-white/5 backdrop-blur border-b border-white/5">
        <div className="rounded-xl bg-zinc-900/70 border border-white/10 p-3 shadow-inner">
          ...
          <div className="text-2xl font-bold text-violet-300">{fps}</div>
        </div>
        <div className="rounded-xl bg-zinc-900/70 border border-white/10 p-3 shadow-inner">
          <div className="text-[11px] uppercase tracking-wide text-zinc-400">
            Landmarks
        ...
        <div className="rounded-xl bg-zinc-900/70 border border-white/10 p-3 shadow-inner">
          ...
          <div className="text-sm text-zinc-200">{format2DData(pose)}</div>
        </div>
        <div className="rounded-xl bg-zinc-900/70 border border-white/10 p-3 shadow-inner">
          <div className="text-[11px] uppercase tracking-wide text-zinc-400">
            Mode
          </div>
          <div className="text-sm text-fuchsia-200">Obstacle overlay</div>
        </div>
      </div>

      {/* Main Content */}
      <div className="flex flex-col xl:grid xl:grid-cols-[1.15fr_0.85fr] gap-6 flex-1 p-6 md:p-8 min-h-0">
        {/* Camera Panel */}
        <div className="flex flex-col gap-4 min-h-0">
          <div className="bg-zinc-900/70 border border-white/10 rounded-2xl shadow-2xl shadow-indigo-900/30 overflow-hidden flex-1 min-h-0">
            <div className="flex items-center justify-between px-4 py-3 bg-white/5 border-b border-white/5">
              ...
              <span className="px-3 py-1 rounded-full text-[11px] bg-fuchsia-500/15 border border-fuchsia-400/40 text-fuchsia-100">
                Obstacles
              </span>
            </div>
            <div
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-xs">
            <div className="rounded-xl border border-white/10 bg-white/5 p-3 text-zinc-200">
              Run in good light for sharper features.
            </div>
            <div className="rounded-xl border border-white/10 bg-white/5 p-3 text-zinc-200">
              Depth/LiDAR boosts close obstacle confidence.
            </div>
            <div className="rounded-xl border border-white/10 bg-white/5 p-3 text-zinc-200">
              Keep movement smooth to reduce blur noise.
            </div>
          </div>
        </div>
        ...
        {/* Data Panel */}
        <div className="flex flex-col gap-4 min-h-0">
          <div className="bg-zinc-900/70 border border-white/10 rounded-2xl shadow-xl overflow-hidden">
            <div className="px-4 py-3 bg-white/5 border-b border-white/5">
              <p className="text-[11px] uppercase tracking-[0.2em] text-violet-300/80">
                Path
              </p>
              <h3 className="text-lg font-semibold">SLAM Trajectory</h3>
            </div>
            <div className="p-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-zinc-900/70 border border-white/10 rounded-2xl shadow-xl p-4">
              <p className="text-[11px] uppercase tracking-[0.2em] text-indigo-300/80">
                Pose
              </p>
